...
- **Dropdown Menus for Faster Entry**: Added dropdowns for wind direction (16-point compass rose), wind strength (Beaufort scale 0-12 with German descriptions), visibility (5 categories from sehr gut to sehr schlecht), and sail plan (vessel-specific: Motor, Großsegel, Genua, Großsegel + Genua, Keine Segel). Speeds up data entry while maintaining optional manual input.
